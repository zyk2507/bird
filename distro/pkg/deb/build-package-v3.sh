...
{
	cat <<'EOF'
Usage: distro/pkg/deb/build-package-v3.sh [--output-dir DIR]

Build a minimal bird3 Debian package.
...
Environment:
  DEB_VERSION   Package upstream version. Defaults to 3.3.0.
...
source_package="bird3"
version="${DEB_VERSION:-3.3.0}"
